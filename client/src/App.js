...
import { Clock, Calendar, User, Globe, Users, Trash2, X, Plus, ListChecks, MessageSquare, AlertTriangle, Info, Loader2 } from 'lucide-react';
                ...
                <div className="p-3 space-y-2">
                    {profiles.map((profile) => (
                        <div key={profile._id} className="flex items-center">
                            ...
                            />
                            <label htmlFor={`profile-${profile._id}`} className="ml-3 text-sm font-medium bg-white cursor-pointer">
                                {profile.name}
                            </label>
                        </div>
                    ))}
        ...
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <div className="text-xl font-extrabold tracking-tight">
            ...
            <p className="text-sm font-light text-gray-500">
                  Create and manage event across multiple timezones
            </p>
          </div>
